...
bibtex_2academic <- function(bibfile,
  ...
  create_md <- function(x) {
    ...
    if (!file.exists(file.path(outsubfold, filename)) | overwrite) {
      ...
      write (paste0("María"),fileConn, append = T)

      # Title and date
      printlog(paste0("title = \"", x[["title"]], "\""))
      ...
      auth_hugo <- stringi::stri_trans_general(auth_hugo, "latin-ascii;Accents-Any")
...
my_bibfile <- "C://Users/mmach/Documents/GitHub/Pruebaweb/content/es/publication/txitos.bib"
outfold   <- "C://Users/mmach/Documents/GitHub/Pruebaweb/content/es/publication/"
